...
create table if not exists public.ig_contas (
  ...
  -- Ciclo de vida da conexao. A varredura diaria coleta so em 'ativa' e passa
  -- por 'pausada' apenas para renovar o token — quem responde essa pergunta e
  -- `public.contas_da_varredura`, no fim deste arquivo. O motor declara o
